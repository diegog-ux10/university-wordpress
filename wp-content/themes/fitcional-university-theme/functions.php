...
{
  wp_enqueue_script('mapbox-js', 'https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.js', array('jquery'), '2.14.1', false);
  wp_enqueue_style('mapbox-css', 'https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.css');
