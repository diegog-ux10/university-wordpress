...
{ 
  wp_enqueue_script('google-Map', '//maps.googleapis.com/maps/api/js?key=AIzaSyDikaIHHjpnOHLTVBprnDgFCjQ7W5oofNA', NULL, '1.0', true);
...
function universityMapKey($api) {
  $api['key'] = 'AIzaSyDikaIHHjpnOHLTVBprnDgFCjQ7W5oofNA';
  return $api;
}
